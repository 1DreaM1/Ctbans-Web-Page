...
<head>
<meta charset="UTF-8" />
<link rel="icon" href="____________LINK TO YOUR IMAGE____________" sizes="32x32" />
<title>
JailBreak | CTBanlist
</title>
<style type="text/css">
...
<div id="mySidenav" class="sidenav">
  ...
  <a target="_blank"	href="____HOME____">OverGame</a>
  <a target="_blank"	href="____BANS____">BanList</a>
  <a target="_blank"	href="____UNBAN____">Unban</a>
  <a target="_blank"	href="____STATS____">HLstatS</a>
</div>
...
$server="____HOST____";
$username="____USER____";
$password="____PSW____";
$database="____DB____";
$table_prefix="___PREFIX__";  //leave empty if none
...
function show_ctban_table($dbh, $query, $results_per_page, $ctbanpage, $table_prefix, $database)
{
	...
	print "<form $action ><input type='text' id='myInput' name='search' placeholder='Search for SteamID, Name, Admin Name, Reason..' title='Type in a SteamID' $required>  <input type='submit' name='submit_search' $value ></form><br>";
	...
	{	
		...
		print "<tr class='h'><th>Name</th><th>Time</th><th>Length</th>"
			. "<th>Admin Name</th><th>Reason</th><th>Remaining</th></tr>\n";
	...
	if (!$dbh) {
		...
		if (!empty($_GET['banid'])) {
			...
			if (empty($row_q)) {
				...
				print "<tr><td><b>Remaining</b></td><td style='color:" . $text_color . ";'>" . $timeleft . "</td></tr>\n";
				print "</table>\n";
				print "<br><br>";
...
<footer class='footer'>&#169; OverGame.eu 2017, code by <a class='dream' href='https://www.overgame.eu'>DreaM</a>, All rights reserved.</footer>
