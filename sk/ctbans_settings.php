...
//	SubHeader Text
$subHeader = "Zoznam CTBanov pre Jailbreak.";
...
if (!$dbh) {
	...
	if (mysqli_query($dbh, $exist) == false) {
		...
		$inf_msg = "<center><b>Prvé prihlásenie: <span style='color:red;'>Meno: <i>admin</i></span> , <span style='color:red;'>Heslo: <i>admin</i></span></b></ceter>";
