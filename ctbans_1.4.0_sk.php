...
<div id="navbar">
	...
	<div class="topnav-left">
		<a style="border-left:0px;" href="https://overgame.eu/">OverGame</a>
		<a href="http://sourcebans.gsp-europe.net/sourcebans_2116/index.php?p=home">BanList</a>
	</div>
  
	<!-- Right-aligned links -->
	<div class="topnav-right">
		<a href="https://overgame.eu/forum/">Fórum</a>
		<a style="border-right:0px;" href="http://hlstatsx.gsp-europe.net/hlx_33701/hlstats.php?game=csgo">HLstatsX</a>
	</div>
	</div>
</div>
...
if (SIDEBAR_ENABLE == true) {
	...
	print "<div id='Sidenav' class='sidenav'>
				<a href='https://overgame.eu/vip/' id='id_1'>EVIP<i style='float:right;' class='material-icons' style='font-size:36px'>grade</i></a>
				<a href='https://overgame.eu/obchod/' id='id_2'>Obchod<i style='float:right;' class='material-icons' style='font-size:36px'>shopping_cart</i></a>
				<a href='https://overgame.eu/forum/memberlist.php?mode=contactadmin&sid=ac62b9f31f2167f60f43a30602d4a81e' id='id_3'>Kontakt<i style='float:right;' class='material-icons' style='font-size:36px'>contact_mail</i></a>
			</div>";
}
?>
	...
	if (!$dbh) {
		...
		if (!empty($_GET['banid'])) {
			...
			if (empty($row_q)) {
				...
				print "<br>";
				print "<table id='spec'>\n";
				print "<tr><td><b>Meno</b></td><td>" . utf8_encode($row_q["perp_name"]) . "</td></tr>\n";
				...
				print "<tr><td><b>Čas Banu</b></td><td>" . date('j. n. Y  H:i', $row_q["timestamp"]) . "</td></tr>\n";
				print "<tr><td><b>Dĺžka Banu</b></td><td>" . $bantime . "</td></tr>\n";
				...
				print "<tr><td><b>Dôvod</b></td><td>" . utf8_encode($row_q["reason"]) . "</td></tr>\n";
				print "<tr><td><b>Zostávajúci čas</b></td><td style='color:" . $text_color . ";'>" . $timeleft . "</td></tr>\n";
